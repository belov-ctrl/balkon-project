...
const portfolioProjects = [
  { 
    ...
    img: 'http://localhost:1337/uploads/thumbnail_Remont_balkona_s_krishei_na_poslednem_etazhe_Khrushchevki_a5d3d1b90a.jpg?updatedAt=2026-06-18T23%3A24%3A35.875Z', 
    totalPrice: '61 013', 
  ...
  { 
    ...
    img: 'http://localhost:1337/uploads/thumbnail_Teploe_osteklenie_lodzhii_3_metra_plastikovim_profilem_61af819026.jpg?updatedAt=2026-06-18T23%3A24%3A54.559Z', 
    totalPrice: '53 412', 
  ...
  { 
    ...
    img: 'http://localhost:1337/uploads/thumbnail_Panoramnii_frantsuzskii_balkon_ot_pola_do_potolka_KBE_3b5a591f2c.jpg?updatedAt=2026-06-18T23%3A25%3A19.358Z', 
    totalPrice: '77 433', 
  ...
  { 
    ...
    img: 'http://localhost:1337/uploads/thumbnail_Osteklenie_balkona_sibirskim_morozostoikim_profilem_Exprof_e226c4da67.jpg?updatedAt=2026-06-18T23%3A25%3A32.975Z', 
    totalPrice: '57 704', 
  ...
  { 
    ...
    img: 'http://localhost:1337/uploads/thumbnail_Rasshirenie_prostranstva_balkona_s_vinosom_naruzhu_1db4d28e4b.jpg?updatedAt=2026-06-18T23%3A25%3A43.799Z', 
    totalPrice: '63 654', 
  ...
  { 
    ...
    img: 'http://localhost:1337/uploads/thumbnail_Blagoustroistvo_bolshoi_6_metrovoi_lodzhii_pod_klyuch_9d873ddd6e.jpg?updatedAt=2026-06-18T23%3A25%3A58.483Z', 
    totalPrice: '186 345', 
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '30px' }}>
          {portfolioProjects.map((project, pIdx) => (
            <div key={pIdx} className="hover-card" style={{ backgroundColor: '#fff', borderRadius: '24px', overflow: 'hidden', border: '1px solid #e2e8f0', display: 'flex', flexDirection: 'column', textAlign: 'left', boxShadow: '0 10px 15px -3px rgba(0,0,0,0.02)' }}>
              <div className="zoom-container" style={{ height: '220px', width: '100%', backgroundColor: '#f8fafc', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '12px' }}>
                <img className="zoom-img" src={project.img} alt={project.title} style={{ maxWidth: '100%', maxHeight: '100%', objectFit: 'contain', borderRadius: '8px' }} />
              </div>
              <div style={{ padding: '28px', flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderTop: '1px solid #f1f5f9', paddingTop: '20px', marginTop: 'auto' }}>
                  ...
                  {/* Кнопка теперь открывает умное окно */}
                  <button 
