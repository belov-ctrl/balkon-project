...
export interface ApiMainPageMainPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    aboutBadge: Schema.Attribute.String;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    glazingCard: Schema.Attribute.Component<'blocks.glazing-card', true>;
    ...
    StructureTab: Schema.Attribute.Component<'blocks.structure-tab', true>;
    topCard1Price: Schema.Attribute.String;
    topCard1Subtitle: Schema.Attribute.String;
    topCard1Title: Schema.Attribute.String;
    topCard2Desc: Schema.Attribute.String;
    topCard2Price: Schema.Attribute.String;
    topCard2Title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
